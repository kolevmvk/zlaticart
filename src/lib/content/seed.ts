...
export const JOURNAL_POSTS: JournalPost[] = [
  ...
  },
  {
    ...
    category: 'Teaching',
    coverImage: {
      src: '/assets/artist-archive/zlatica-archive-01.webp',
      alt: 'Zlatica at work',
      width: 800,
      height: 1000,
    },
...
export const ARTIST_PROFILE: ArtistProfile = {
  ...
  atelierImages: [
    { src: '/assets/artist-archive/zlatica-archive-02.webp', alt: 'Zlatica in the atelier', width: 800, height: 1000 },
    { src: '/assets/artist-archive/zlatica-archive-03-color.webp', alt: 'Zlatica at work', width: 800, height: 1000 },
    { src: '/assets/artist-archive/zlatica-archive-04.webp', alt: 'Studio moment', width: 800, height: 1000 },
  ],
